...
var UserWhere = struct {
	...
	Gender:      whereHelperbool{field: "\"users\".\"gender\""},
	DateOfBirth: whereHelpertime_Time{field: "\"users\".\"date_of_birth\""},
	AccountID:   whereHelperint{field: "\"users\".\"account_id\""},
}
...
type userR struct {
	...
	UserFolders UserFolderSlice `boil:"UserFolders" json:"UserFolders" toml:"UserFolders" yaml:"UserFolders"`
...
func (r *userR) GetUserFolders() UserFolderSlice {
	if r == nil {
		return nil
	}
	return r.UserFolders
}

func (r *userR) GetUserTests() UserTestSlice {
	if r == nil {
		return nil
	}
	return r.UserTests
...
func (r *userR) GetWords() WordSlice {
	if r == nil {
		return nil
	}
	return r.Words
...
var (
	userAllColumns            = []string{"id", "last_name", "first_name", "gender", "date_of_birth", "account_id"}
	userColumnsWithoutDefault = []string{"last_name", "first_name", "gender", "date_of_birth", "account_id"}
...
// UserFolders retrieves all the user_folder's UserFolders with an executor.
func (o *User) UserFolders(mods ...qm.QueryMod) userFolderQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_folder\".\"user_id\"=?", o.ID),
	)
...
func (o *User) UserTests(mods ...qm.QueryMod) userTestQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_tests\".\"user_id\"=?", o.ID),
	)
...
func (o *User) Words(mods ...qm.QueryMod) wordQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"user_words\" on \"words\".\"id\" = \"user_words\".\"word_id\""),
		qm.Where("\"user_words\".\"user_id\"=?", o.ID),
	)
...
// LoadUserFolders allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserFolders(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_folder`),
		qm.WhereIn(`user_folder.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice user_folder")
	}
	...
	if singular {
		object.R.UserFolders = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.UserFolders = append(local.R.UserFolders, foreign)
				if foreign.R == nil {
					foreign.R = &userFolderR{}
				}
				foreign.R.User = local
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserTests(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_tests`),
		qm.WhereIn(`user_tests.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadWords(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.Select("\"words\".\"id\", \"words\".\"word\", \"words\".\"definition\", \"words\".\"example\", \"words\".\"pronouciation\", \"words\".\"type\", \"words\".\"manager_id\", \"a\".\"user_id\""),
		qm.From("\"words\""),
		qm.InnerJoin("\"user_words\" as \"a\" on \"words\".\"id\" = \"a\".\"word_id\""),
...
// AddUserFolders adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UserFolders.
// Sets related.R.User appropriately.
func (o *User) AddUserFolders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserFolder) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.UserFolders = append(o.R.UserFolders, related...)
	}
...
// Sets related.R.User appropriately.
func (o *User) AddUserTests(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserTest) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
...
func (o *User) AddWords(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Word) error {
	var err error
	for _, rel := range related {
		if insert {
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
	...
	for _, rel := range related {
		query := "insert into \"user_words\" (\"user_id\", \"word_id\") values ($1, $2)"
		values := []interface{}{o.ID, rel.ID}
...
// Sets o.R.Users's Words accordingly.
// Replaces o.R.Words with related.
// Sets related.R.Users's Words accordingly.
func (o *User) SetWords(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Word) error {
	query := "delete from \"user_words\" where \"user_id\" = $1"
	...
	removeWordsFromUsersSlice(o, related)
	if o.R != nil {
		o.R.Words = nil
	}
...
func (o *User) RemoveWords(ctx context.Context, exec boil.ContextExecutor, related ...*Word) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"user_words\" where \"user_id\" = $1 and \"word_id\" in (%s)",
...
func removeWordsFromUsersSlice(o *User, related []*Word) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
