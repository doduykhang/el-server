...
var LessonWhere = struct {
	...
	ID:          whereHelperint{field: "\"lessons\".\"id\""},
	Name:        whereHelperstring{field: "\"lessons\".\"name\""},
	Description: whereHelperstring{field: "\"lessons\".\"description\""},
	ManagerID:   whereHelperint{field: "\"lessons\".\"manager_id\""},
}
...
var (
	lessonAllColumns            = []string{"id", "name", "description", "manager_id"}
	lessonColumnsWithoutDefault = []string{"name", "description", "manager_id"}
...
func (lessonL) LoadWords(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLesson interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"words\".\"id\", \"words\".\"word\", \"words\".\"definition\", \"words\".\"example\", \"words\".\"pronouciation\", \"words\".\"type\", \"words\".\"manager_id\", \"a\".\"lesson_id\""),
		qm.From("\"words\""),
...
func (o *Lesson) AddWords(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Word) error {
	...
	for _, rel := range related {
		query := "insert into \"words_in_lessons\" (\"lesson_id\", \"word_id\") values ($1, $2)"
		values := []interface{}{o.ID, rel.ID}
...
func (o *Lesson) SetWords(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Word) error {
	query := "delete from \"words_in_lessons\" where \"lesson_id\" = $1"
...
func (o *Lesson) RemoveWords(ctx context.Context, exec boil.ContextExecutor, related ...*Word) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"words_in_lessons\" where \"lesson_id\" = $1 and \"word_id\" in (%s)",
...
func FindLesson(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Lesson, error) {
	lessonObj := &Lesson{}
	...
	query := fmt.Sprintf(
		"select %s from \"lessons\" where \"id\"=$1", sel,
	)
...
func (o *Lesson) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO \"lessons\" %sDEFAULT VALUES%s"
		}
...
func (o *Lesson) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"lessons\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert lessons")
	}
...
func LessonExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"lessons\" where \"id\"=$1 limit 1)"
